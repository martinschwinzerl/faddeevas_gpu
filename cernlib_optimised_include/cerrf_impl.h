...
CERRF_STATIC CERRF_FN void cerrf_optimised_impl( double x, double y,
...
CERRF_INLINE void cerrf_optimised_impl(
    __private double x, __private double y,
    __private double* restrict out_x,
    __private double* restrict out_y )
{
    /**
