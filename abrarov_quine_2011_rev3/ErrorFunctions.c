...
#include "abrarov_quine_2011_rev2/ErrorFunctions.h"
...
void cerf_abrarov_quine_rev2_ext( real_type in_x, real_type in_y,
    CERRF_RESULT_DEC real_type* CERRF_RESTRICT out_x,
    CERRF_RESULT_DEC real_type* CERRF_RESTRICT out_y ) CERRF_NOEXCEPT
{
    cerf_abrarov_quine_rev2( in_x, in_y, out_x, out_y, &CERRF_FOURIER_COEFF[ 0 ],
        &CERRF_TAYLOR_COEFF[ 0 ] );
}

void cerfc_abrarov_quine_rev2_ext( real_type in_x, real_type in_y,
    CERRF_RESULT_DEC real_type* CERRF_RESTRICT out_x,
    CERRF_RESULT_DEC real_type* CERRF_RESTRICT out_y ) CERRF_NOEXCEPT
{
    cerf_abrarov_quine_rev2( in_x, in_y, out_x, out_y, &CERRF_FOURIER_COEFF[ 0 ],
...
int wofz_abrarov_quine_rev2_ext( real_type in_x, real_type in_y,
    CERRF_RESULT_DEC real_type* CERRF_RESTRICT out_x,
    CERRF_RESULT_DEC real_type* CERRF_RESTRICT out_y ) CERRF_NOEXCEPT
{
    wofz_abrarov_quine_rev2( in_x, in_y, out_x, out_y, &CERRF_FOURIER_COEFF[ 0 ],
        &CERRF_TAYLOR_COEFF[ 0 ] );
